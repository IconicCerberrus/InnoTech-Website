  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        aria-hidden
        className="pointer-events-none absolute left-[-260px] top-1/2 z-10 h-[min(720px,110vh)] max-w-none -translate-y-1/2 select-none md:left-[-190px]"
      />
      <img
        src={inceptionRightExclude}
        alt=""
        aria-hidden
        className="pointer-events-none absolute right-[-260px] top-1/2 z-10 h-[min(720px,110vh)] max-w-none -translate-y-1/2 select-none md:right-[-190px]"
      />
