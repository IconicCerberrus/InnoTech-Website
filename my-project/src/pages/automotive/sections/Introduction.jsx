  ...
  return (
    <div className="self-stretch px-28 py-14 inline-flex flex-col justify-start items-start gap-2.5">
      <div className="self-stretch relative flex flex-col justify-center items-start gap-4">
        {/* Green Circle */}
        <div className="size-16 left-[05px] top-[-19px] absolute rounded-full border border-Green" />

        {/* Title */}
        <div className="self-stretch justify-start px-6 text-white text-4xl font-normal font-['Gotham']">
          INTRODUCTION
        </div>
